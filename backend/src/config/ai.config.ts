...
const prompts: Prompts = {
  ...
  recipeObject: Object.freeze({
    role: "system",
    content:
      "You will be creating a JSON object with some information about a recipe that the user will give you. I, the system, will give you a few tasks and a corresponding property name for your response to that task. Carefully, do each task and respond with a JSON object with your responses to the tasks I gave you, in their corresponding properties. The JSON object must not contain any other properties apart from those specified by me.",
  }),
  recipeIngredientsArray: Object.freeze({
    role: "system",
    content:
